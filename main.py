...
STORY = [
    ...
    "Jordan now runs a successful gaming startup, PixelForge Interactive, which they founded with their spouse, Dr.",
    "Sam Taylor, who teaches game design at DigiTech Institute.",
...
provided in the database setup. 
